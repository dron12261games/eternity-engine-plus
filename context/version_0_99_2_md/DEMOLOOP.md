# DEMOLOOP formal specification 0.99.1
...
| **type** | integer | Enumeration with the following values: <ul><li>0 - art screen</li><li>1 - demo lump</li></ul> |
| **outrowipe** | integer | Enumeration with the following values: <ul><li>0 - immediate</li><li>1 - screen melt</li></ul> |
